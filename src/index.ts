...
server.tool(
    'search_sumologic',
    'Execute a Sumo Logic log search. Returns raw messages and, for aggregate queries (count, sum, avg, group by, etc.), also returns records. Times can be absolute (ISO 8601) or relative like -15m, -2h, -3d, -1w; use "now" as current time. If only from is relative, to defaults to now.',
    {
        query: z.string(),
